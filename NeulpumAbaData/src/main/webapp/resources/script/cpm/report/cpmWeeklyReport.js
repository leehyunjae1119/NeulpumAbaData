...
function makeWeeklyReport(data) {
	
	isWeeklyReportComplate = true;
	
	var dateSpan = $("#reportStartDt").val() + ' ~ ' + $("#reportEndDt").val();
	$("#weeklyReportDate").text(dateSpan);
	$("#weeklyReportName").text(_childrenInfo.childrenName);
